...
// This function handles updating the user's personal account information.
...
// Get client data based on the Client's ID
function getClientById($clientId){
    $db = phpmotorsConnect();
    $sql = 'SELECT clientEmail, clientFirstname, clientLastname, clientEmail, clientLevel, clientPassword FROM clients WHERE clientId = :clientId';
    $stmt = $db->prepare($sql);
